...
Domain 'law' has Description 'The constitution laws as canon: carrier unfolding, set algebra, and the seven checks law:report names — gates are definitions the mu applies, never host code.'.
