...
"use strict";
{
  ...
  try {
    ...
    for (const name of ["law:rmap_idempotence", "law:table_is_fetch",
      ...
      "law:currying", "law:emission", "law:navmap", "law:induce", "law:derive", "law:rules", "law:finiteness", "law:induce_facts", "law:machine", "law:catalog", "law:apply", "law:thm1", "law:thm2", "law:one_name"]) {
